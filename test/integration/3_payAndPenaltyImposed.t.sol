...
contract Integration_3_PayAndPenaltyImposedTest is IntegrationBaseTest {
  ...
  function run() public virtual override {
    ...
    assertEq(mortgagePosition.termBalance, 111483800000000000000028, "[1] termBalance");
    ...
    assertEq(mortgagePosition.termBalance, 111483800000000000000028, "[2] termBalance");
    ...
    assertEq(mortgagePosition.termPaid, (111483800000000000000028 / 36) * 4, "[2] termPaid");
